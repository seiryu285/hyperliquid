...
![HyperLiquid Dashboard](./docs/images/dashboard-preview.png)
...
HyperLiquid取引システムには、以下の機能を備えた高度なデータ視覚化ダッシュボードが含まれています：

- **価格チャート**: ローソク足チャートとテクニカル指標の表示
- **オーダーブック**: リアルタイムのオーダーブック深度表示
- **テクニカル指標**: RSI、MACD、ボリンジャーバンドなどの指標表示
- **ポジション概要**: 現在のポジションとリスク評価
- **取引履歴**: 最近の取引履歴と実行詳細

![Dashboard Components](./docs/images/dashboard-components.png)
